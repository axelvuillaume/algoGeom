import pygame
from const import VORONOI_BACKGROUND_COLOR, WHITE, TITLE_MARGIN_TOP, POLYGON_COLOR, POLYGON_LINE_WIDTH
from config import SCREEN_WIDTH
from utils import generate_random_dots, get_convex_hull_points, FindCircumcenter, detectIllegalEdge, addVoronoiEdges
from shapes import Triangle, Circle, Dot
import math 
...
class voronoi : 
    ...
    def draw(self):
        self.screen.fill(VORONOI_BACKGROUND_COLOR)

        text_surface = self.font.render('Voronoi', True, WHITE)
